        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              {/* Redirect old routes to /people for backwards compatibility */}
              <Route path="/feed" element={<Navigate to="/people" replace />} />
              <Route path="/find-people" element={<Navigate to="/people" replace />} />
